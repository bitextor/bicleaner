...
Please, visit https://github.com/bitextor/bitextor-data/releases/tag/bicleaner-v1.0 to download the language packages.
...
* positional arguments:
  ...
  * metadata: Training metadata (YAML file), generated by `bicleaner-train` or [downloaded](https://github.com/bitextor/bitextor-data/releases/tag/bicleaner-v1.0) as a part of a language pack. 
* optional arguments:
...
In case you need to train a new classifier (i.e. because it is not available in the language packs provided in [bitextor-data](https://github.com/bitextor/bitextor-data/releases/tag/bicleaner-v1.0), 
